        ...
        <div className='mx-auto my-10 py-10 px-5 bg-[#edeff3] space-y-5'>
            ...
            <div className='container mx-auto grid md:grid-cols-3 justify-between gap-5'>
                <div className='flex flex-col items-center justify-center space-y-5 bg-white rounded-xl p-10 relative'>
                    ...
                    <img src={User} alt="" className='bg-linear-to-r from-[#4f39f62f] to-[#9614fa2f] p-3 rounded-[50%]' />
                ...
                <div className='flex flex-col items-center justify-center space-y-5 bg-white rounded-xl p-10 relative'>
                    ...
                    <img src={Package} alt="" className='bg-linear-to-r from-[#4f39f62f] to-[#9614fa2f] p-3 rounded-[50%]' />
                ...
                <div className='flex flex-col items-center justify-center space-y-5 bg-white rounded-xl p-10 relative'>
                    ...
                    <img src={Rocket} alt="" className='bg-linear-to-r from-[#4f39f62f] to-[#9614fa2f]  p-3 rounded-[50%] ' />
